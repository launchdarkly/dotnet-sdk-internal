...
namespace LaunchDarkly.Sdk.Internal.Helpers
{
    public static class Util
    {
        ...
        public static Dictionary<string, string> GetRequestHeaders(IHttpRequestConfiguration config,
        ...
        public static HttpClient MakeHttpClient(IHttpRequestConfiguration config, ClientEnvironment env)
        {
        ...
        public static bool IsHttpErrorRecoverable(int status)
        {
        ...
        public static string HttpErrorMessage(int status, string context, string recoverableMessage)
        {
        ...
        public static string HttpErrorMessageBase(int status)
        {
        ...
        public static HashCodeBuilder Hash()
        {
